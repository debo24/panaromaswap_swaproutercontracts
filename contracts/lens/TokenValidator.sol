...
import 'panaromaswap_v3periphery/contracts/base/PeripheryImmutableState.sol';
import 'panaromaswap_v2core/contracts/interfaces/IPanaromaswapV2Callee.sol';
import 'panaromaswap_v2core/contracts/interfaces/IPanaromaswapV2Pair.sol';
import '../libraries/PanaromaswapV2Library.sol';
...
contract TokenValidator is ITokenValidator, IPanaromaswapV2Callee, ImmutableState {
    string internal constant FOT_REVERT_STRING = 'FOT';
    // https://github.com/Panaromaswap/v2-core/blob/1136544ac842ff48ae0b1b939701436598d74075/contracts/PanaromaswapV2Pair.sol#L46
    ...
    function _validate(
        ...
        address pairAddress = PanaromaswapV2Library.pairFor(this.factoryV2(), token, baseToken);
        ...
        (, bytes memory returnData) = address(pairAddress).call(abi.encodeWithSelector(IPanaromaswapV2Pair.token0.selector));
        ...
        IPanaromaswapV2Pair pair = IPanaromaswapV2Pair(pairAddress);
    ...
    function panaromaswapV2Call(
        address,
        uint256 amount0,
        uint256,
        bytes calldata data
    ) external view override {
        IPanaromaswapV2Pair pair = IPanaromaswapV2Pair(msg.sender);
