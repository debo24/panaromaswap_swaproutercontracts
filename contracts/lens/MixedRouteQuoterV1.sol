...
import 'panaromaswap_v3periphery/contracts/libraries/CallbackValidation.sol';
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IPanaromaswapV3SwapCallback, PeripheryImmutableState {
    ...
    function getPairAmountOut(
        ...
        (uint256 reserveIn, uint256 reserveOut) = PanaromaswapV2Library.getReserves(factoryV2, tokenIn, tokenOut);
