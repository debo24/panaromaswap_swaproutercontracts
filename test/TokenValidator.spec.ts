...
import { TokenValidator, TestERC20, IPanaromaswapV2Pair__factory } from '../typechain'
...
describe('TokenValidator', function () {
  ...
  it('succeeds to return unknown when flash loaning full reserves', async () => {
    ...
    const pair = IPanaromaswapV2Pair__factory.connect(pairAddress, ethers.provider)
