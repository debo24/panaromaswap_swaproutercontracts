...
import { IPanaromaswapV2Pair, IWETH9, MockTimeSwapRouter02, MixedRouteQuoterV1, TestERC20 } from '../typechain'
...
describe('SwapRouter', function () {
  ...
  async function createV2Pool(tokenA: TestERC20, tokenB: TestERC20): Promise<IPanaromaswapV2Pair> {
    await factoryV2.createPair(tokenA.address, tokenB.address)

    const pairAddress = await factoryV2.getPair(tokenA.address, tokenB.address)
    const pair = new ethers.Contract(pairAddress, PAIR_V2_ABI, wallet) as IPanaromaswapV2Pair
  ...
  describe('swaps - v2', () => {
    let pairs: IPanaromaswapV2Pair[]
    let wethPairs: IPanaromaswapV2Pair[]
