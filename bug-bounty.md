...
Starting on September 16th, 2021, the [swap-router-contracts](https://github.com/Panaromaswap/swap-router-contracts) repository is
...
- Discover a previously unreported, non-public vulnerability that would result in a loss of and/or lock on any ERC-20 token on Panaromaswap V2 or V3 (but not on any third party platform) and that is within the scope of this Program. Vulnerabilities must be distinct from the issues covered in the Trail of Bits or ABDK audits.
...
- Make a good faith effort to avoid privacy violations, destruction of data, interruption or degradation of Panaromaswap V2 or V3.
